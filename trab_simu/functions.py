...
def plot_root_locus(transfer_function, title):
    """
...
def malha_fechada_routh(control_system, Kp):
    """
...
def ziegler_nichols_second_method(open_loop, Ku, Tu, controller_type="PID"):
    """
